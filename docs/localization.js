(() => {
  ...
  const translations = {
    ja: {
      ...
      downloadVersion: "Token Meter 1.1.8をダウンロード",
      viewScreens: "画面を見る",
    ...
    en: {
      ...
      downloadVersion: "Download Token Meter 1.1.8",
    ...
    "zh-CN": {
      ...
      downloadVersion: "下载 Token Meter 1.1.8",
      viewScreens: "查看界面",
    ...
    ko: {
      ...
      downloadVersion: "Token Meter 1.1.8 다운로드",
      viewScreens: "화면 보기",

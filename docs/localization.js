(() => {
  ...
  const translations = {
    ja: {
      ...
      downloadVersion: "Token Meter 1.1.3をダウンロード",
      viewScreens: "画面を見る",
      ...
      featureTwoBody: "Full、Compact、Icon onlyから選択。残量、今日のトークン数、5時間枠のリセットまでを必要に応じて表示できます。",
    ...
    en: {
      ...
      downloadVersion: "Download Token Meter 1.1.3",
      ...
      featureTwoBody: "Choose Full, Compact, or Icon only. Show remaining usage, today's tokens, and the 5-hour reset only when you need them.",
      ...
      downloadTitle: "A quieter way<br>to check your limits.",
    ...
    "zh-CN": {
      ...
      downloadVersion: "下载 Token Meter 1.1.3",
      viewScreens: "查看界面",
      ...
      featureTwoBody: "可选择完整、紧凑或仅图标模式，并按需显示剩余用量、今日 Token 数量和 5 小时重置时间。",
    ...
    ko: {
      ...
      downloadVersion: "Token Meter 1.1.3 다운로드",
      viewScreens: "화면 보기",
      ...
      featureTwoBody: "전체, 컴팩트, 아이콘 전용 중에서 선택하고 잔여량, 오늘의 토큰 수, 5시간 초기화 시간을 필요할 때만 표시하세요.",
      ...
      downloadLabel: "다운로드",
      downloadTitle: "더 조용하게<br>잔여량을 확인하세요.",

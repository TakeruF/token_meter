(() => {
  ...
  const translations = {
    ja: {
      ...
      promoDashboardCaption: "ダッシュボードで、日別・モデル別の内訳まで。",
      promoLanguagesAlt: "英語・日本語・中国語・韓国語を選べるToken Meterの設定画面",
      promoLanguagesCaption: "日本語 / English / 中文 / 한국어に対応。",
      showcaseAria: "アプリ画面と機能",
      featureOneTitle: "3つのAIを、同じ場所で。",
      featureOneBody: "Claude CodeとCodexを並べて表示。GitHub Copilot CLIにも対応します（トークン数のみの集計、デフォルトはオフ）。使うプロバイダーだけを選べます。",
      providersImageAlt: "ClaudeとCodexを選択するプロバイダー設定画面",
      providersCaption: "プロバイダー選択",
      featureTwoTitle: "メニューバーは、あなたの見やすさで。",
      featureTwoBody: "Full、Compact、Icon onlyから選択。Claude CodeとCodexに表示する5時間枠または週次枠を選べます。5時間枠を選んだ際、Codex Proに5時間枠がなければ週次枠を自動表示します。",
      ...
      setupLabel: "セットアップ",
      setupTitle: "数分で準備完了。",
      setupBody: "初期設定では、選んだプロバイダーの使用量を実際に読み取れるかまで確認します。読み取れない場合は、未ログインやセッションログ未作成など、直すべき点を具体的に表示。今は設定を終えて、あとから接続しても構いません。",
      setupManualLink: "Claude Codeのサインインとキーチェーン許可を手動で行う",
      ...
      windowsAvailability: "Windows版は開発凍結済みで、配布・サポートしていません。",
      footerReleases: "リリース",
    ...
    en: {
      ...
      downloadVersion: "Download Token Meter 1.2.8",
      ...
      promoDashboardCaption: "The dashboard breaks usage down by day and by model.",
      promoLanguagesAlt: "The Token Meter settings screen with the English, Japanese, Chinese, and Korean language picker open",
      promoLanguagesCaption: "Available in English, Japanese, Chinese, and Korean.",
      showcaseAria: "App screens and features",
      featureOneTitle: "Three AIs. One place.",
      featureOneBody: "See Claude Code and Codex side by side, with GitHub Copilot CLI available too — token counts only, off by default. Choose which providers to display.",
      providersImageAlt: "Provider settings for selecting Claude and Codex",
      providersCaption: "Provider selection",
      featureTwoTitle: "A menu bar that works your way.",
      featureTwoBody: "Choose Full, Compact, or Icon only. Choose the 5-hour or weekly limit for both Claude Code and Codex; when 5-hour is selected, Codex Pro automatically falls back to weekly if no 5-hour limit is available.",
      ...
      setupBody: "Setup verifies that usage can actually be read for the providers you picked. If it can't, you get the specific reason — signed out, no session log yet — instead of a blank meter. Finish setup now and connect later if you prefer.",
      setupManualLink: "Sign in to Claude Code and grant Keychain access manually",
      ...
      windowsAvailability: "Windows development is frozen; Windows is not distributed or supported.",
    ...
    "zh-CN": {
      ...
      promoDashboardCaption: "仪表盘按日期与模型细分用量。",
      promoLanguagesAlt: "Token Meter 设置界面中打开的英语、日语、中文、韩语切换菜单",
      promoLanguagesCaption: "支持英语、日语、简体中文和韩语。",
      showcaseAria: "应用界面与功能",
      featureOneTitle: "三个 AI，一个位置。",
      featureOneBody: "并排显示 Claude Code 和 Codex，同时支持 GitHub Copilot CLI（仅统计 Token 数量，默认关闭）。您可只选择需要的提供商。",
      providersImageAlt: "选择 Claude 和 Codex 的提供商设置界面",
      providersCaption: "提供商选择",
      featureTwoTitle: "按你的方式显示菜单栏。",
      featureTwoBody: "可选择完整、紧凑或仅图标模式。可为 Claude Code 和 Codex 选择显示 5 小时或每周限额；选择 5 小时限额时，Codex Pro 若没有该限额会自动改用每周限额。",
      ...
      setupLabel: "设置",
      setupTitle: "几分钟即可完成。",
      setupBody: "初始设置会确认能否实际读取所选提供商的使用量。若无法读取，会明确告知原因——未登录、尚无会话日志等，而不是留下空白。您也可以先完成设置，稍后再连接。",
      setupManualLink: "手动完成 Claude Code 登录与钥匙串授权",
      ...
      windowsAvailability: "Windows 版开发已冻结，不再分发或提供支持。",
      footerReleases: "版本发布",
      footerPrivacy: "隐私",
      footerSource: "源代码",
      footerLicense: "许可证",
    ...
    ko: {
      ...
      promoDashboardCaption: "대시보드에서 날짜별·모델별 내역까지.",
      promoLanguagesAlt: "영어, 일본어, 중국어, 한국어를 선택할 수 있는 Token Meter 설정 화면",
      promoLanguagesCaption: "English / 日本語 / 中文 / 한국어를 지원합니다.",
      showcaseAria: "앱 화면 및 기능",
      featureOneTitle: "세 AI를 한곳에서.",
      featureOneBody: "Claude Code와 Codex를 나란히 표시하고, GitHub Copilot CLI도 지원합니다(토큰 수만 집계, 기본값 꺼짐). 사용할 제공자만 선택할 수 있습니다.",
      providersImageAlt: "Claude와 Codex를 선택하는 제공자 설정 화면",
      providersCaption: "제공자 선택",
      featureTwoTitle: "내게 맞는 메뉴 막대 표시.",
      featureTwoBody: "전체, 컴팩트, 아이콘 전용 중에서 선택하세요. Claude Code와 Codex 모두에 표시할 5시간 또는 주간 한도를 선택할 수 있습니다. 5시간 한도를 선택했을 때 Codex Pro에 해당 한도가 없으면 주간 한도로 자동 전환합니다.",
      ...
      setupBody: "초기 설정에서 선택한 제공자의 사용량을 실제로 읽을 수 있는지까지 확인합니다. 읽을 수 없으면 미로그인, 세션 로그 없음 등 고쳐야 할 점을 구체적으로 알려 줍니다. 지금 설정을 마치고 나중에 연결해도 됩니다.",
      setupManualLink: "Claude Code 로그인과 키체인 접근을 수동으로 설정하기",
      ...
      windowsAvailability: "Windows 버전 개발은 동결되었으며 배포하거나 지원하지 않습니다.",
      footerReleases: "릴리스",
      footerPrivacy: "개인정보",
      footerSource: "소스 코드",
      footerLicense: "라이선스",
